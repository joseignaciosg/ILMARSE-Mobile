...
public class ProductsProviderImpl extends AbstractProductProvider{
	
	List<Product> products;
	

	public ProductsProviderImpl(String productsUrl) {
		super(productsUrl);
	}
	
	public ProductsProviderImpl(List<Product> products) {
		super();
		if ( products == null ) {
